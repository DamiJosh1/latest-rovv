    ...
    <section className="py-20 md:py-16 lg:py-20 px-4 md:px-6 bg-[#FFFAF2]">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col lg:flex-row lg:justify-between lg:items-center gap-3 md:gap-6 lg:gap-20 mb-6 md:mb-10 lg:mb-10">
          <div className="w-full lg:w-auto flex justify-center lg:justify-start">
            <div className="relative w-[343px] h-[329px] md:w-[519px] md:h-[495.86px] lg:w-[628px] lg:h-[600px] rounded-[33.06px] lg:rounded-[40px] overflow-hidden">
              <img src={Image} alt="ROVV Driver" className="w-full h-full object-cover" />
            </div>
          </div>

          <div className="flex flex-col gap-4 w-full max-w-[343px] md:max-w-[519px] lg:max-w-[519px] mx-auto lg:mx-0">
            {steps.map((step, i) => (
              <div key={i} className="flex gap-3 md:gap-6 p-3 md:p-6 border-2 border-[#CDBBE1] rounded-[24px] md:rounded-[40px]">
        ...
        <div className="flex flex-col lg:flex-row lg:items-center gap-6 md:gap-6 lg:gap-[132px]">
          <div className="flex flex-col gap-3 lg:gap-4 w-full lg:w-auto">
            ...
            <div className="flex flex-col gap-3 w-full lg:max-w-[628px]">
              {requirements.map((req, i) => (
                <div key={i} className="flex items-center gap-4 px-10 py-6 bg-[#5E239D] rounded-[4px]">
                  <img src={arrow} alt="arrow" className="w-8 h-8 shrink-0" />
          ...
          <div className="flex flex-col gap-[14px] p-7 md:p-10 w-full max-w-[388px] md:max-w-[519px] lg:max-w-[775px] mx-auto lg:mx-0 bg-[#FFEFD6] rounded-[4px]">
        ...
        {showModal && (
          ...
          >
            ...
            >
              ...
              {/* FLEX MODE DESIGN INSIDE SINGLE BORDER */}
