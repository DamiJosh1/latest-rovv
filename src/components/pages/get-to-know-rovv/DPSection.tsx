...
export default function DriverRiderFeatures() {
  ...
  return (
    <section className="py-5 md:py-15 px-6 bg-bg">
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-5">
          ...
          <h2 className="text-2xl lg:text-5xl md:text-2xl font-nohemi font-bold text-dark">
          ...
          <div className="order-1 lg:order-2 md:order-2">
            ...
            <div className="flex justify-center mb-5">
              <button
                ...
                className={`relative pb-2 px-2 font-medium transition-colors duration-75 ${
                  activeTab === 'passenger'
                    ?  ' text-medium w-40 lg:w-50 md:w-40 '
                    : 'text-medium w-40 md:w-40 lg:w-50 '
                }`}
              >
                For Passengers
                <span
              ...
              <button
                onClick={() => setActiveTab('driver')}
                 className={`relative pb-2 px-2  font-medium transition-colors duration-75 ${
                  activeTab === 'driver'
                    ?  ' text-medium w-40 md:w-30 lg:w-50'
                    : 'text-medium w-40 md:w-30 lg:w-50'
                }`}
              >
                For Drivers
            ...
            >
              {(activeTab === 'passenger' ? passengerFeatures : driverFeatures).map((feature, i) => (
                ...
                >
                  <h3 className="text-[24px] md:text-[18px] font-medium leading-6  text-dark">
                    {feature.title}
                  </h3>
