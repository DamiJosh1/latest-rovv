  ...
  return (
    <>
      ...
      <section className="lg:pt-10 lg:pb-10 lg:mt-20 md:mt-10 lg:pr-20 lg:pl-20 sm:px-6 md:px-8 bg-bg gap-2.5">
        <div className="hero-container h-[800px] max-w-[414px] md:max-w-[704px] md:h-[1049.22px] lg:max-w-[1276px] lg:h-[572px] justify-between mx-auto grid grid-cols-1 lg:grid-cols-2">
          {/* LEFT TEXT */}
