...
export default function TestimonialsSection() {
  ...
  return (
    <section className="bg-[#FFFAF2] py-10 px-4 md:px-8 lg:px-[194px]">
      <div className="max-w-[1052px] mx-auto flex flex-col items-center gap-8">

        {/* Eyebrow */}
        <div className="bg-[#FFF2DE] px-5 py-1 rounded-full">
        ...
        {/* Glass container */}
        <div className="w-full bg-[rgba(94,35,157,0.2)] backdrop-blur-[50px] rounded-3xl shadow-[inset_0_0_40px_8px_#fff] p-5 lg:p-7">
            ...
            <div className="flex-1 bg-[#5E239D] rounded-3xl px-7 py-6 text-white flex flex-col gap-4">
              ...
              <div className="flex gap-1">
                {[...Array(5)].map((_, i) => (
                  <span
                    key={i}
                    className="text-[#FFEFD6] text-[22px] leading-none"
                  >
                    ★
                  </span>
                ))}
